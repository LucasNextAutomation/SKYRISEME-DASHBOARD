...
const nav = [
  ...
  { label: "Videos & Website", href: "/dashboard/staging", icon: Image, number: "03", badge: "Month 3", locked: true },
  { label: "WhatsApp & Newsletters", href: "/dashboard/voice", icon: Mic, number: "04", badge: "Month 4", locked: true },
