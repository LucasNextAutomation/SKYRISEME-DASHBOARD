...
const systems = [
  ...
  },
  {
    ...
    description: "Voice notes transcribed and processed into CRM actions — zero manual data entry",
    features: [
      ...
      "Action items created automatically from conversations",
  ...
  },
  {
    ...
    description: "Generate feasibility studies and send personalized newsletters to your contact list",
    features: [
      ...
      "AI Knowledge Assistant: ask anything about your portfolio",
    ],
    icon: MessageSquare,
