...
const systems = [
  ...
  },
  {
    ...
    description: "AI-powered video production, social media content, and a new professional website for SkyRise Me",
    features: [
      "Professional AI video production by our expert collaborator",
      "Auto-post listings to Instagram and Facebook",
      "New SkyRise Me website — modern, professional portfolio showcase",
  ...
  },
  {
    ...
    description: "Voice notes transcribed into CRM actions, WhatsApp automation, and personalized newsletters",
    features: [
      "Arabic, French & English transcription — including Lebanese dialect",
      "WhatsApp Business: property cards, viewings, automated replies",
      "Automatic CRM updates from voice notes",
      "Automated newsletters with personalized property selections",
      "Team notifications for new inquiries and visit summaries",
    ],
    icon: Mic,
  ...
  },
  {
    ...
    description: "Financial feasibility studies on demand, full system optimization and team training",
    features: [
      "Financial study generator: land cost + construction → full report",
      "Construction cost modeling with Lebanese market data",
      "Market insights: neighborhood trends and pricing analytics",
      "Full system optimization across all 5 systems",
...
const dataFlow = [
  ...
  { label: "Processing", items: ["Automation Server", "Secure Database", "AI Engine", "Real-time Sync"], icon: "🧠" },
  { label: "Intelligence", items: ["Database Cleanup", "Follow-up Engine", "Video Production", "Voice Processing", "Financial Analysis"], icon: "⚡" },
  { label: "Actions", items: ["Auto Sequences", "Social Media Posts", "CRM Updates", "Market Reports"], icon: "🎯" },
];
